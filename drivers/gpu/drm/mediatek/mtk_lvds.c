...
#define VPLL_PWR_ON \
	(RG_VPLL_SDM_ISO_EN | RG_VPLL_SDM_PWR_ON |\
	RG_VPLL_TXDIV5_EN | RG_VPLL_LVDS_TTL_EN |\
	RG_VPLL_LVDS_DPIX_DIV2 | RG_VPLL_LVDS_EN |\
	RG_VPLL_TXDIV1)
			    ...
			    unsigned int bpc,  struct cmdq_pkt *cmdq_pkt)
{
	...
	writel(VPLL_PWR_ON, lvds->regs_ana + MIPI_LVDS_ANA1C);

	udelay(20);

	writel(VPLL_PWR_ON & ~RG_VPLL_SDM_ISO_EN,
